      ...
      <div className="lg:flex lg:space-x-5 xl:flex-col ">
        <div className="mt-[30px]">
          <a
            ...
            className="cursor-pointer border border-[#6D895C]  bg-white custom-rounded xl:pb-[30px] pb-[15px] pl-[5px]  xl:pt-[20px]  xl:w-[357px] xl:h[79px]"
          >
            <button className=" cursor-pointer bg-[#6D895C] xl:py-[25px] xl:px-[77px]  py-[10px] px-[10px] w-[250px] xl:w-[357px] xl:h[79px]  custom-rounded">
        ...
        <div className="mt-[30px]">
          ...
          >
            <button className=" cursor-pointer bg-[#6D895C] xl:py-[25px] xl:px-[77px]  py-[10px] px-[60px] w-[250px] xl:w-[357px] xl:h[79px]   custom-rounded">
              <h6 className="text-white text-[14px] md:text-[18px] font-bold text-center lg:text-start">
                Education
              </h6>
            </button>
